...
export class Navbar {
  ...
  protected isClientManagementRoute = false;
  protected isDataManagementRoute = false;
  protected userRole = '';
  protected displayName = '';
  protected allowedRoutes: string[] = [];
  protected routePaths = RoutePaths;
  protected landingPageRoute = '';
  ...
  constructor() {
    this.landingPageRoute = this.routesService.getLandingPage();
    this.router.events
      ...
      .subscribe((event: NavigationEnd) => {
        ...
        this.isClientManagementRoute =
          currentUrl.startsWith('/client-management');
        this.isDataManagementRoute = currentUrl.startsWith('/data-management');
